                ...
                <table>
                    ...
                    @foreach ($order_receipt as $key => $receipt)
                        <tr class="service">
                            ...
                            <td class="tableitem">
                                <p class="itemtext">{{ $currencySymbol }}{{ number_format($receipt->unitprice, 2) }}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{ $receipt->discount ? ' ' : '0' }}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemmake">{{ $currencySymbol }}{{ number_format($receipt->amount, 2) }}</p>
                            </td>
                        </tr>
                    @endforeach
                    <tr class="tabletitle">
                        ...
                        <td class="payment">
                            <h2>{{ $currencySymbol }}{{ number_format($order_receipt->sum('amount'), 2) }}</h2>
                        </td>
                    </tr>
