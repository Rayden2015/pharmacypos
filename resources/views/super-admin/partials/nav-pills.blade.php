<div class="d-flex flex-wrap gap-2 mb-3">
    ...
    <a href="{{ route('super-admin.companies.index') }}" class="btn btn-sm {{ request()->routeIs('super-admin.companies.*', 'super-admin.tenant-admins.*') ? 'btn-primary' : 'btn-outline-primary' }}">Tenants (companies)</a>
